...
class GeneralScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(inscript==false||uidSession==null){
    ...
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child:Conditional(
          ...
          condition:inscript,
          onConditionTrue: Center(child:Container(
                      ...
                      onTap: () {
                        showCupertinoDialog(
                          ...
                          builder: (BuildContext context) => CupertinoAlertDialog(
                            title: const Text('Modo de Juego Junior: \n Split 10 segundos, 5 preguntas'),
                            actions: <Widget>[
